## Enable OpenCode in the Agent window

If OpenCode models show up in the editor chat but are missing from the new agent window / background agent, allowlist the extension in `settings.json`:
